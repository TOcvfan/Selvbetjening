...
public class MainActivity extends ListActivity {
    //private String[] productList = {"Aston Martin", "Audi", "BMW", "Buick", "Cadillac", "Chevrolet", "Ford", "Mazda", "Volvo", "Seat", "Toyota" };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.activity_main, productList);
        ...
        listView.setOnItemClickListener( new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick( AdapterView<?> parent, View view,
                int position, long id) { String sObject  = ( String ) listView.getItemAtPosition( position );
                Toast.makeText( MainActivity.this, "SObject: "+ sObject.toString() ,
